...
Ejercicio 5:
El ejercicio 5 está formado por inputs de tipo text y un input de tipo date, además de dos controles de inputs de ficheros llamados file.
Que al dar submit muestra el valor de los inputs.
